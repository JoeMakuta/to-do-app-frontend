  ...
  return (
    <div className="bg-[#000000] h-screen">
      <div className="bg-darkIndogo h-screen">
        ...
        <div className="container flex flex-col-reverse md:flex-row   justify-between px-6 mx-auto mt-10 space-y-0 md:space-y-0">
          {/* image */}
          ...
          {/* Right item */}
          <div className="flex flex-col mb-32 md:w-1/3">
